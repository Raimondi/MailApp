...
- (id)initWithTargetType:(ASTargetType)targetType_ data:(id)targetData_ {
    ...
    appData = [[ASAppData alloc] initWithApplicationClass: [AEMApplication class]
                                            constantClass: [MLConstant class]
                                           referenceClass: [MLReference class]
...
- (MLReference *)AS_referenceWithObject:(id)object {
    if ([object isKindOfClass: [MLReference class]])
        return [[[MLReference alloc] initWithAppData: AS_appData
